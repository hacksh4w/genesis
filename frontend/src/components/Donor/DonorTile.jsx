...
const DonorTile = (props) => {
    return (
        <Flex h={280} w={220} minW={190} bgColor={'blue.50'} borderRadius={'10'} p={4} direction={'column'} alignItems={"center"}  justifyContent={'space-between'}>
            <Box bgColor={'blue.100'} w={100} h={100} borderRadius={'70'} mb={5}></Box>
            ...
            <Button colorScheme="blue" mt={3} borderRadius={'20'} >View</Button>
        </Flex>
    );
}
